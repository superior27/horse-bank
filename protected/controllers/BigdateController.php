...
class BigdateController extends Controller
{
	/**
	 ...
	 * @return Bigdate the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Bigdate::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Bigdate $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bigdate-form')
		{
